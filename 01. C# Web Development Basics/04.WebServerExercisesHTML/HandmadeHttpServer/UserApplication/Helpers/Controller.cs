namespace HandmadeHttpServer.GreetingApplication.Helpers
{
    using HandmadeHttpServer.Server.Enums;
    using HandmadeHttpServer.Server.Http.Contracts;
    using HandmadeHttpServer.Server.Http.Response;
    using HandmadeHttpServer.GreetingApplication.Views;
    ...
    {
        public const string DefaultPath = @"GreetingApplication\Resources\{0}.html";
