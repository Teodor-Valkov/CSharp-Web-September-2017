namespace FitStore.Web.Controllers
{
    ...
    public class CommentsController : Controller
    {
        ...
        public CommentsController(UserManager<User> userManager, ICommentService commentService, ISupplementService supplementService)
        {
        ...
        public async Task<IActionResult> Restore(int id, int supplementId)
        {
            ...
            await this.commentService.RestoreAsync(id);
